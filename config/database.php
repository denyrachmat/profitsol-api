    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv_pc' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_PC_HOST', 'localhost'),
            'port' => env('DB_PC_PORT', '1433'),
            'database' => env('DB_PC_DATABASE', 'forge'),
            'username' => env('DB_PC_USERNAME', 'forge'),
        ...
        'sqlsrv_wis' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_WIS_HOST', 'localhost'),
            'port' => env('DB_WIS_PORT', '1433'),
            'database' => env('DB_WIS_DATABASE', 'forge'),
            'username' => env('DB_WIS_USERNAME', 'forge'),
            'password' => env('DB_WIS_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],

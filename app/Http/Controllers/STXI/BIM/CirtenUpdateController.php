...
class CirtenUpdateController extends BaseController
{
    ...
    public function syncTenList($year)
    {
        ...
        Excel::import($importer1, 'TECHNICAL NOTICE LIST - PRINTER IEI.xlsx', 'la_bim_ten_list');

        $importer2 = new ImportTENList($year, 0);

        Excel::import($importer2, 'TECHNICAL NOTICE LIST - PROJECTOR.xlsx', 'la_bim_ten_list');

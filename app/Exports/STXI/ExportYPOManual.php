    ...
    public function collection()
    {
        ...
        foreach ($this->data as $key => $value) {
            ...
            $hasil[] = [
                ...
                'YPO_MRPDT' => $key > 0 && $value['id'] === $this->data[$key - 1]['id'] ? '' : Date::PHPToExcel(strtotime($value['YPO_MRPDT'])),
                'YPO_MAILDT' => $key > 0 && $value['id'] === $this->data[$key - 1]['id'] ? '' : Date::PHPToExcel(strtotime($value['YPO_MAILDT'])),
                'YPO_RCVDT' => $key > 0 && $value['id'] === $this->data[$key - 1]['id'] ? '' : Date::PHPToExcel(strtotime($value['YPO_RCVDT'])),

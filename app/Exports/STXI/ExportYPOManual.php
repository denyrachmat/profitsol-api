    ...
    public function collection()
    {
        ...
        foreach ($this->data as $key => $value) {
            ...
            $hasil[] = [
                ...
                'YPO_MRPDT' => $key > 0 && $value['id'] === $this->data[$key - 1]['id'] ? '' : date('Y-m-d',(Date::excelToTimestamp(strtotime($value['YPO_MRPDT'])) + 14400))/**Date::PHPToExcel(strtotime($value['YPO_MRPDT']) + 14400)**/,
                'YPO_MAILDT' => $key > 0 && $value['id'] === $this->data[$key - 1]['id'] ? '' : Date::PHPToExcel(strtotime($value['YPO_MAILDT']) + 14400),
                'YPO_RCVDT' => $key > 0 && $value['id'] === $this->data[$key - 1]['id'] ? '' : Date::PHPToExcel(strtotime($value['YPO_RCVDT']) + 14400),
